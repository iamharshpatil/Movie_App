...
const Moviedetails = () => {
  ...
  return info ? (
    ...
    >
      {/* Part 1: Navigation */}
      <nav className="w-full max-sm:hidden h-[11vh] items-center text-zinc-100 flex gap-10 text-xl">
        <Link
          onClick={() => navigate(-1)}
      ...
      <div className="max-sm:flex-col max-sm:mt-5 w-full flex ">
        <img
        ...
        <div className="ml-[5%] max-sm:mt-1 text-white">
          ...
          <div className="flex  max-sm:hidden  gap-5 mt-2">
            <p>
              Release Date:{" "}
          ...
          {/* Trailer Link */}
            <Link 
            className="text-xl rounded-lg p-5 bg-[#1980E6]"
      ...
      <h1 className="text-3xl max-sm:text-xl mb-5 font-bold text-white">
